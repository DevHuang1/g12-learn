...
const quesDB: QuesDB = {
  ...
  "Phrasal verbs": [
{ id: 1, question: "I hope I will ___ this final exam. (A. turn up, B. bring up, C. get through)", answer: ["C"] },
{ id: 2, question: "The meeting was ___ until next week. (A. put off, B. called up, C. taken over)", answer: ["A"] },
{ id: 3, question: "She decided to ___ smoking. (A. set off, B. break out, C. give up)", answer: ["C"] },
{ id: 4, question: "Please ___ your shoes before entering. (A. take after, B. take over, C. take off)", answer: ["C"] },
{ id: 5, question: "The plane will ___ in ten minutes. (A. take after, B. take off, C. take up)", answer: ["B"] },
{ id: 6, question: "I will ___ the meaning of this word. (A. look over, B. look after, C. look up)", answer: ["C"] },
{ id: 7, question: "She ___ her grandmother while her parents are away. (A. looks into, B. looks up, C. looks after)", answer: ["C"] },
{ id: 8, question: "We must ___ a solution to this problem. (A. come across, B. come up with, C. come over)", answer: ["B"] },
{ id: 9, question: "I ___ an old friend yesterday. (A. ran into, B. ran away, C. ran over)", answer: ["A"] },
{ id: 10, question: "Please ___ the lights before leaving. (A. turn into, B. turn off, C. turn over)", answer: ["B"] },

{ id: 11, question: "He tried to ___ the noise. (A. put up with, B. put away, C. put over)", answer: ["A"] },
{ id: 12, question: "The teacher asked us to ___ the homework. (A. hand out, B. hand in, C. hand over)", answer: ["B"] },
{ id: 13, question: "They decided to ___ a new company. (A. set off, B. set up, C. set down)", answer: ["B"] },
{ id: 14, question: "The car suddenly ___. (A. broke away, B. broke down, C. broke over)", answer: ["B"] },
{ id: 15, question: "She ___ her father in personality. (A. takes in, B. takes off, C. takes after)", answer: ["C"] },
{ id: 16, question: "The police will ___ the case. (A. look after, B. look for, C. look into)", answer: ["C"] },
{ id: 17, question: "We will ___ early tomorrow. (A. set down, B. set off, C. set up)", answer: ["B"] },
{ id: 18, question: "He ___ a new hobby last year. (A. took after, B. took up, C. took over)", answer: ["B"] },
{ id: 19, question: "She ___ the invitation politely. (A. turned over, B. turned down, C. turned out)", answer: ["B"] },
{ id: 20, question: "The firemen managed to ___ the fire. (A. put away, B. put out, C. put up)", answer: ["B"] },

{ id: 21, question: "Please ___ the form carefully. (A. fill over, B. fill in, C. fill out)", answer: ["B"] },
{ id: 22, question: "We must ___ the plan immediately. (A. carry away, B. carry out, C. carry on)", answer: ["B"] },
{ id: 23, question: "The meeting was ___ because of rain. (A. called up, B. called off, C. called in)", answer: ["B"] },
{ id: 24, question: "He ___ a story during the meeting. (A. made off, B. made up, C. made out)", answer: ["B"] },
{ id: 25, question: "I need to ___ what happened. (A. find out, B. find up, C. find over)", answer: ["A"] },
{ id: 26, question: "The teacher will ___ the test papers. (A. give out, B. give away, C. give off)", answer: ["A"] },
{ id: 27, question: "He decided to ___ his old clothes. (A. throw off, B. throw away, C. throw up)", answer: ["B"] },
{ id: 28, question: "She quickly ___ the new language. (A. picked over, B. picked off, C. picked up)", answer: ["C"] },
{ id: 29, question: "The thief managed to ___. (A. get across, B. get away, C. get through)", answer: ["B"] },
{ id: 30, question: "I will ___ my notes before the exam. (A. go under, B. go over, C. go across)", answer: ["B"] },

{ id: 31, question: "Please ___ the volume. (A. turn up, B. turn out, C. turn over)", answer: ["A"] },
{ id: 32, question: "The baby finally ___. (A. calmed up, B. calmed down, C. calmed over)", answer: ["B"] },
{ id: 33, question: "They ___ the old building. (A. pulled out, B. pulled down, C. pulled off)", answer: ["B"] },
{ id: 34, question: "Write ___ your answers clearly. (A. up, B. down, C. off)", answer: ["B"] },
{ id: 35, question: "She ___ the offer immediately. (A. turned in, B. turned down, C. turned over)", answer: ["B"] },
{ id: 36, question: "He ___ the challenge bravely. (A. took after, B. took off, C. took on)", answer: ["C"] },
{ id: 37, question: "I accidentally ___ a great article online. (A. came across, B. came down, C. came over)", answer: ["A"] },
{ id: 38, question: "The students ___ when the teacher arrived. (A. stood in, B. stood over, C. stood up)", answer: ["C"] },
{ id: 39, question: "She ___ the baby gently. (A. picked over, B. picked off, C. picked up)", answer: ["C"] },
...
{ id: 42, question: "The teacher asked him to ___ the answer. (A. work up, B. work over, C. work out)", answer: ["C"] },
{ id: 43, question: "She ___ her coat because it was warm. (A. took out, B. took off, C. took over)", answer: ["B"] },
{ id: 44, question: "The manager will ___ new employees. (A. take over, B. take up, C. take on)", answer: ["C"] },
{ id: 45, question: "He ___ the truth eventually. (A. brought over, B. brought up, C. brought out)", answer: ["B"] },
{ id: 46, question: "Please ___ the application form. (A. fill away, B. fill over, C. fill out)", answer: ["C"] },
{ id: 47, question: "The company will ___ a new branch. (A. open up, B. open down, C. open over)", answer: ["A"] },
{ id: 48, question: "He ___ the meeting confidently. (A. carried on, B. carried over, C. carried away)", answer: ["A"] },
{ id: 49, question: "She ___ the problem quickly. (A. sorted up, B. sorted over, C. sorted out)", answer: ["C"] },
